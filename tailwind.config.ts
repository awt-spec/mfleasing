    ...
    extend: {
      ...
      colors: {
        ...
        flow: {
          ...
          danger: "hsl(var(--flow-danger))",
          warning: "hsl(var(--flow-warning))",
          decision: "hsl(var(--flow-decision))",
          info: "hsl(var(--flow-info))",
          special: "hsl(var(--flow-special))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(358, 78%, 45%, 0.3)" },
          "50%": { boxShadow: "0 0 40px -5px hsl(358, 78%, 45%, 0.5)" },
        },
      },
      animation: {
        ...
        "zoom-in": "zoom-in 0.7s cubic-bezier(0.22, 1, 0.36, 1) forwards",
